...
import 'package:sql_lite_2/features/AuditEntity/data/datasources/database/drift_database.dart';
import 'package:sql_lite_2/features/AuditEntity/data/models/audit_model.dart';
...
class AuditEntityDataSourceImpl extends AuditEntityDataSource {
  ...
  Future<void> getJsonAndInsertAuditEntity() async {
    ...
    await rootBundle.rootBundle.loadString('assests/SQLite_Audit.json');
